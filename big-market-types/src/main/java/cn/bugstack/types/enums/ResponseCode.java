...
public enum ResponseCode {
    ...
    UN_ASSEMBLED_STRATEGY_ARMORY("ERR_BIZ_002", "抽奖策略配置未装配，请通过IStrategyArmory接口进行装配"),
    ...
    ACCOUNT_MONTH_QUOTA_ERROR("ERR_BIZ_007","账户当月额度不足"),
    ACCOUNT_DAY_QUOTA_ERROR("ERR_BIZ_008","账户当日额度不足"),
